...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interview_identity', models.IntegerField(choices=[(1, '侯场教室'), (2, '面试教室')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interview_status', models.IntegerField(choices=[(1, '未签到'), (2, '已签到候场'), (3, '已经出发'), (4, '面试开始'), (5, '面试结束'), (6, '第一志愿队列'), (7, '第二志愿队列'), (8, '最终队列'), (9, '已录取')])),
